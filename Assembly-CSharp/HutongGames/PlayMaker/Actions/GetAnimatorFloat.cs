...
{
	[ActionCategory("Animator"), HutongGames.PlayMaker.Tooltip("Gets the value of a float parameter")]
	public class GetAnimatorFloat : FsmStateAction
	{
		...
		[RequiredField, HutongGames.PlayMaker.Tooltip("The animator parameter")]
		public FsmString parameter;

		[HutongGames.PlayMaker.Tooltip("Repeat every frame. Useful when value is subject to change over time.")]
		public bool everyFrame;

		[ActionSection("Results"), RequiredField, HutongGames.PlayMaker.Tooltip("The float value of the animator parameter"), UIHint(UIHint.Variable)]
