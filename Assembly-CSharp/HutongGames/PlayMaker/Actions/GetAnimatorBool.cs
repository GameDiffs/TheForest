...
{
	[ActionCategory("Animator"), HutongGames.PlayMaker.Tooltip("Gets the value of a bool parameter")]
	public class GetAnimatorBool : FsmStateAction
	{
		...
		[ActionSection("Results"), RequiredField, HutongGames.PlayMaker.Tooltip("The bool value of the animator parameter"), UIHint(UIHint.Variable)]
