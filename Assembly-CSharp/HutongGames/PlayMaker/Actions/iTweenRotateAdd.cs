...
{
	[ActionCategory("iTween"), HutongGames.PlayMaker.Tooltip("Adds supplied Euler angles in degrees to a GameObject's rotation over time.")]
	public class iTweenRotateAdd : iTweenFsmAction
	{
		...
		[RequiredField, HutongGames.PlayMaker.Tooltip("A vector that will be added to a GameObjects rotation.")]
