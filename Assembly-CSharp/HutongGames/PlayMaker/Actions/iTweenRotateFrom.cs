...
{
	[ActionCategory("iTween"), HutongGames.PlayMaker.Tooltip("Instantly changes a GameObject's Euler angles in degrees then returns it to it's starting rotation over time.")]
