...
{
	[ActionCategory("iTween"), HutongGames.PlayMaker.Tooltip("Instantly rotates a GameObject to look at the supplied Vector3 then returns it to it's starting rotation over time.")]
