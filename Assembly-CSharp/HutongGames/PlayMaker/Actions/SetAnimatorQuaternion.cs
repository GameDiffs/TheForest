...
{
	[ActionCategory("Animator"), HelpUrl("https://hutonggames.fogbugz.com/default.asp?W1073"), HutongGames.PlayMaker.Tooltip("Sets the value of a quaternion parameter")]
	public class SetAnimatorQuaternion : FsmStateAction
	{
		...
		[HutongGames.PlayMaker.Tooltip("The Quaternion value to assign to the animator parameter")]
