...
namespace HutongGames.PlayMaker.Actions
{
	...
	{
		[CheckForComponent(typeof(Animator)), CheckForComponent(typeof(NavMeshAgent)), CheckForComponent(typeof(PlayMakerAnimatorMoveProxy)), RequiredField, HutongGames.PlayMaker.Tooltip("The Agent target. An Animator component and a PlayMakerAnimatorMoveProxy component are required")]
