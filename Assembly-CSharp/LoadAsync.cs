...
public class LoadAsync : MonoBehaviour
{
	...
	{
		LoadAsync.<LoadLevelWithProgress>c__Iterator1A5 <LoadLevelWithProgress>c__Iterator1A = new LoadAsync.<LoadLevelWithProgress>c__Iterator1A5();
		<LoadLevelWithProgress>c__Iterator1A.levelToLoad = levelToLoad;
		<LoadLevelWithProgress>c__Iterator1A.<$>levelToLoad = levelToLoad;
		<LoadLevelWithProgress>c__Iterator1A.<>f__this = this;
		return <LoadLevelWithProgress>c__Iterator1A;
	}
}
