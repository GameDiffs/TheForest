...
namespace OrbCreationExtensions
{
	public static class MeshExtensions
	{
		...
		{
			MeshExtensions.<MakeLODMeshInBackground>c__Iterator1D4 <MakeLODMeshInBackground>c__Iterator1D = new MeshExtensions.<MakeLODMeshInBackground>c__Iterator1D4();
			<MakeLODMeshInBackground>c__Iterator1D.maxWeight = maxWeight;
			<MakeLODMeshInBackground>c__Iterator1D.removeSmallParts = removeSmallParts;
			<MakeLODMeshInBackground>c__Iterator1D.mesh = mesh;
			<MakeLODMeshInBackground>c__Iterator1D.result = result;
			<MakeLODMeshInBackground>c__Iterator1D.recalcNormals = recalcNormals;
			<MakeLODMeshInBackground>c__Iterator1D.<$>maxWeight = maxWeight;
			<MakeLODMeshInBackground>c__Iterator1D.<$>removeSmallParts = removeSmallParts;
			<MakeLODMeshInBackground>c__Iterator1D.<$>mesh = mesh;
			<MakeLODMeshInBackground>c__Iterator1D.<$>result = result;
			<MakeLODMeshInBackground>c__Iterator1D.<$>recalcNormals = recalcNormals;
			return <MakeLODMeshInBackground>c__Iterator1D;
		}
