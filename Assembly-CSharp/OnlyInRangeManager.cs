...
public class OnlyInRangeManager : MonoBehaviour
{
	...
	{
		OnlyInRangeManager.<HideItem>c__Iterator1D0 <HideItem>c__Iterator1D = new OnlyInRangeManager.<HideItem>c__Iterator1D0();
	...
	{
		OnlyInRangeManager.<ViewItem>c__Iterator1D1 <ViewItem>c__Iterator1D = new OnlyInRangeManager.<ViewItem>c__Iterator1D1();
