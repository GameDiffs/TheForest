...
namespace UniLinq
{
	internal class QuickSort<TElement>
	{
		...
		{
			QuickSort<TElement>.<Sort>c__Iterator200 <Sort>c__Iterator = new QuickSort<TElement>.<Sort>c__Iterator200();
			<Sort>c__Iterator.source = source;
			<Sort>c__Iterator.context = context;
			<Sort>c__Iterator.<$>source = source;
			<Sort>c__Iterator.<$>context = context;
			QuickSort<TElement>.<Sort>c__Iterator200 expr_23 = <Sort>c__Iterator;
			expr_23.$PC = -2;
			return expr_23;
		}
	}
