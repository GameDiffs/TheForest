...
[Serializer(typeof(Font)), Serializer(typeof(AnimationClip)), Serializer(typeof(AudioClip)), Serializer(typeof(TextAsset)), SubTypeSerializer(typeof(Mesh)), SubTypeSerializer(typeof(Texture))]
