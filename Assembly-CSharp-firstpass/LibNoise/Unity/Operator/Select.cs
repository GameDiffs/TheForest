		...
		public override double GetValue(double x, double y, double z)
		{
			...
			if (this.m_fallOff > 0.0)
			{
				...
				if (value < this.m_min + this.m_fallOff)
				{
					...
					return Utils.InterpolateLinear(this.m_modules[0].GetValue(x, y, z), this.m_modules[1].GetValue(x, y, z), position);
				}
				...
				if (value < this.m_max + this.m_fallOff)
				{
					...
					return Utils.InterpolateLinear(this.m_modules[1].GetValue(x, y, z), this.m_modules[0].GetValue(x, y, z), position);
				}
				return this.m_modules[0].GetValue(x, y, z);
			}
			else
